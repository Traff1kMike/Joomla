...
$show_date = ($params->get('show_publish_date'))? 1: 0;
$show_date = ($show_date || $params->get('show_create_date'))? 1: 0;
?>

<div class="post 
	<?php if ( !$show_date ) { ?>no-date<?php } ?>
	...
	<?php if ($params->get('show_publish_date') || $params->get('show_create_date') ) { ?>
		...
		<span class="date">
			...
			<br/><small><?php echo JHTML::_('date', $this->item->modified, JText::_('M')); ?></small>
	...
	<div class="post-title">
		...
		<?php $useDefList = ( ($params->get('show_author')) OR ($params->get('show_category')) OR ($params->get('show_parent_category'))
							OR ($params->get('show_modify_date')) OR ($params->get('show_hits')) ); ?>
