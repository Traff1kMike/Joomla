...
define('MOD_RSDIRECTORY_NEWEST_ENTRIES_VERSION', '1.0.2');

/**
 * RSDirectory! Newest Entries Module Helper.
 */
abstract class RSDirectoryNewestEntriesHelper
{
    /**
    ...
    public static function getEntries($params)
    {
		...
		$query = $db->getQuery(true)
			   ...
			   ->order( $db->qn('e.published_time') . ' DESC' );
