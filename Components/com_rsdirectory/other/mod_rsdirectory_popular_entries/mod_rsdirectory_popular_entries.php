...
$entries = RSDirectoryPopularEntriesHelper::getEntries($params);
...
JFactory::getDocument()->addStyleSheet( JUri::root(true) . '/media/mod_rsdirectory_popular_entries/css/style.css?v=' . MOD_RSDIRECTORY_POPULAR_ENTRIES_VERSION );


include JModuleHelper::getLayoutPath('mod_rsdirectory_popular_entries', 'default');