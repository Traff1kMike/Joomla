...
$entries = RSDirectoryTopRatedEntriesHelper::getEntries($params);
...
$doc->addStyleSheet( JURI::root(true) . '/media/mod_rsdirectory_top_rated_entries/css/style.css?v=' . MOD_RSDIRECTORY_TOP_RATED_ENTRIES_VERSION );

if ($display_ratings)
{
	$doc->addScript( JURI::root(true) . '/media/com_rsdirectory/js/jquery.raty.min.js?v=' . RSDirectoryVersion::$version );
	$doc->addScript( JURI::root(true) . '/media/mod_rsdirectory_top_rated_entries/js/script.js?v=' . MOD_RSDIRECTORY_TOP_RATED_ENTRIES_VERSION );
}


include JModuleHelper::getLayoutPath('mod_rsdirectory_top_rated_entries', 'default');