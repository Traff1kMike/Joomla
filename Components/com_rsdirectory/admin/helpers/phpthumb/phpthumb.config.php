...
$PHPTHUMB_CONFIG['cache_directory'] = dirname(__FILE__) . '/../../../../../components/com_rsdirectory/files/phpthumb_cache/'; // set the cache directory relative to the phpThumb() installation
...
$PHPTHUMB_CONFIG['cache_prefix'] = strtolower( 'phpthumb_cache_'. (isset($_SERVER['SERVER_NAME']) ? str_replace('www.', '', $_SERVER['SERVER_NAME']) . '_' : '') ); // keep cache file separate by domain
