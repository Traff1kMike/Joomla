...
class JSecurImage {
        ...
        */
        ...
        function JSecurImage()
        {
                ...
                $this->signature_font  = dirname(__FILE__) . '/AHGBold.ttf';

                $this->audio_path   = dirname(__FILE__) . '/audio/';
    ...
    imagefilledrectangle($this->tmpimg, 0, 0, $this->image_width * $this->iscale, $this->image_height * $this->iscale, $this->gdbgcolor);
        ...
        function saveData()
        {
                ...
                $session->set('com_rsdirectory.securimage.value', $this->code);
                $session->set('com_rsdirectory.securimage.ctime', time());
        }
        ...
        function validate()
        {
                ...
                if ($code != '' && $code == $code_entered)
                {
                    ...
                    $session->set('com_rsdirectory.securimage.value', '');
                    $session->set('com_rsdirectory.securimage.ctime', '');
                }
        }
        ...
        {
                $session = JFactory::getSession();
                return $session->set('com_rsdirectory.securimage.value', '');
        }
        ...
        {
                $session = JFactory::getSession();
                $creation_time = $session->get('com_rsdirectory.securimage.ctime', 0);
                $expired = true;
