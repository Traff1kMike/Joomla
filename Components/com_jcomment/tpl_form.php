...
?>
<div id="respond">
<h6 id="reply-title"><?php echo JText::_('FORM_HEADER'); ?></h6>
<?php
...
<div class="comment-form-author control-group">
	<div class="controls">
		<input type="text" value="" name="name" id="comments-form-name" aria-required="true" size="40"  maxlength="<?php echo $this->getVar('comment-name-maxlength');?>" size="22" tabindex="1"/>
		
	</div>
	
	<label for="comments-form-name" class="control-label"><?php echo $text; ?></label>
</div>
<?php
		}
...
<div class="comment-form-email control-group">
	<div class="controls">
		<input id="comments-form-email" type="text" name="email" value="" size="40" tabindex="2" />
	</div>
	<label for="comments-form-email" class="control-label"><?php echo $text; ?></label>
...
<div class="comment-form-url control-group">
	<div class="controls">
		<input id="comments-form-homepage" type="text" name="homepage" value="" size="40" tabindex="3" />
	</div>
	<label for="comments-form-homepage" class="control-label"><?php echo $text; ?></label>
</div>
<?php } ?>
...
<?php } ?>
	...
	<div class="controls">
		<textarea id="comments-form-comment" name="comment" cols="32" rows="8" tabindex="5"></textarea>
	</div>
...
?>
<div class="comment-form-subscribe control-group">
	<div class="controls">
...
<div id="comments-form-buttons control-group" style="margin-top:20px;">

	<div class="controls" id="comments-form-send">
		<a href="#" tabindex="7" onclick="jcomments.saveComment();return false;" title="<?php echo JText::_('FORM_SEND_HINT'); ?>" class="btn btn-success">
			<?php echo JText::_('POST COMMENT'); ?></a>
		<div class="" id="comments-form-cancel" style="display:none;"><a href="#" tabindex="8" onclick="return false;" title="<?php echo JText::_('FORM_CANCEL'); ?>"><?php echo JText::_('FORM_CANCEL'); ?></a></div>
	</div>
